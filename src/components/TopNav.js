...
const TopNav = () => {
    ...
    console.log(sideNav)
  return (
    <div className='max-w-[1520px] mx-auto flex justify-between item-center p-4'>
        <div className='flex items-center'>
            <div onClick={()=> setSideNav(!sideNav)} className='cursor-pointer'>
                <AiOutlineMenu size={25}/>
            </div>
            <h1 className='text-2xl sm:text-2xl lg:text-4xl px-2'>Sole 
                <span className='font-bold text-orange-700'>Gin</span>
            </h1>
        ...
        <button className='bg-orange-700 border-orange-700 text-white hidden md:flex items-center py-2 rounded-full'>
        ...
        </button>
        {
            ...
            />
            <h2 className='text-2xl p-4'>Sole<span className='text-orange-700 font-bold'>Gin</span></h2>
                <nav>
